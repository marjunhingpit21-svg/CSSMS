...
$inStockQ    = $conn->query("SELECT COUNT(*) FROM products p LEFT JOIN product_sizes ps ON p.product_id = ps.product_id WHERE ps.product_size_id IS NOT NULL GROUP BY p.product_id HAVING COALESCE(SUM(ps.stock_quantity),0) > 20")->num_rows;
$lowStockQ   = $conn->query("SELECT COUNT(*) FROM products p LEFT JOIN product_sizes ps ON p.product_id = ps.product_id WHERE ps.product_size_id IS NOT NULL GROUP BY p.product_id HAVING COALESCE(SUM(ps.stock_quantity),0) BETWEEN 1 AND 20")->num_rows;
$outStockQ   = $conn->query("SELECT COUNT(*) FROM products p LEFT JOIN product_sizes ps ON p.product_id = ps.product_id WHERE ps.product_size_id IS NOT NULL GROUP BY p.product_id HAVING COALESCE(SUM(ps.stock_quantity),0) = 0")->num_rows;
    ...
    <main>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card emerald-teal">
                ...
                <p class="stat-value green">298</p>
            </div>
            <div class="stat-card amber-orange">
                <p class="stat-label">Low Stock</p>
                <p class="stat-value orange">31</p>
            </div>
            <div class="stat-card red-rose">
                <p class="stat-label">Out of Stock</p>
                <p class="stat-value red">13</p>
            </div>
        </div>
        ...
        <div class="table-container">
            ...
            <div class="pagination-section">
                <p class="pagination-info">Showing <span>1-10</span> of <span>342</span> products</p>
                <div>
