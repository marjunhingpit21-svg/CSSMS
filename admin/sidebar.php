...
<<<<<<< HEAD
        <a href="/CSSMS/admin/dashboard/index.php">
=======
        <a href="/CSSMS/admin/dashboard/index.php" class="<?= strpos($current, '/dashboard') !== false ? 'active' : '' ?>">
>>>>>>> b79113a9be55458b9a94a170d4c5cb59c6239160
        ...
        <a href="/CSSMS/admin/suppliers/index.php" class="<?= strpos($current, '/suppliers') !== false ? 'active' : '' ?>">
            <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sidebar-dropdown <?= (strpos($current, '/users/customers_') !== false || 
                                        strpos($current, '/users/employees_') !== false) ? 'open' : '' ?>">

            <a href="#" class="sidebar-nav-link dropdown-toggle <?= (strpos($current, '/users/customers_') !== false || 
                                                                strpos($current, '/users/employees_') !== false) ? 'active' : '' ?>">
                <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
