                    ...
                    <div class="checkout-main">
                        ...
                        <div class="checkout-section">
                            ...
                            <?php if (!empty($addresses)): ?>
                                <div class="saved-addresses">
                                    ...
                                    foreach ($addresses as $index => $addr):
                                        $shouldCheck = !$defaultChecked && ($addr['is_default'] == 1 || $index === 0);
                                        if ($shouldCheck)
                                            $defaultChecked = true;
                                        ?>
                            ...
                            <div id="address-form-container"
                                ...
                                <p><?php echo empty($addresses) ? 'Enter your shipping address' : 'Add new address'; ?>
                                </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <small style="color: #666;">Email is taken from your account and cannot be changed
                                        here</small>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="address_label" name="address_label"
                                            value="<?php echo htmlspecialchars($_POST['address_label'] ?? 'Home'); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>
                                ...
                                <?php foreach ($_SESSION['cart'] as $item): ?>
                                    <div class="summary-item">
                                        <div class="item-info">
                                            ...
                                            <p>Size: <?php echo htmlspecialchars($item['size']); ?> ×
