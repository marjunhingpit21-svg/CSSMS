...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['place_order'])) {
    ...
    if (empty($first_name) || empty($last_name) || empty($email) || empty($phone) || 
        ...
        try {
            ...
            $customer_id = null;
            $check_customer = $conn->prepare("SELECT customer_id FROM customers WHERE user_id = ?");
            ...
            if ($result->num_rows > 0) {
                ...
                $update_customer->bind_param("sssssssi", $first_name, $last_name, $email, $phone, $address, $city, $postal_code, $customer_id);
                ...
                $insert_customer->bind_param("isssssss", $_SESSION['user_id'], $first_name, $last_name, $email, $phone, $address, $city, $postal_code);
            ...
            foreach ($_SESSION['cart'] as $item) {
                ...
                $cost_price = $cost_result->fetch_assoc()['cost_price'];
                ...
                if ($size_result->num_rows > 0) {
                    ...
                    // For order_items, we need inventory_id
