...
<body>
                                ...
                                <div class="address-card <?php echo $addr['is_default'] ? 'default' : ''; ?>">
                                    ...
                                    <div class="address-actions">
                                        ...
                                        <button class="btn-icon btn-delete"
                                            onclick="deleteAddress(<?php echo $addr['address_id']; ?>)">
                                            <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="order-card">
                                    ...
                                    <div class="order-details">
                                        <div class="order-info">
                                            <span><?php echo $order['item_count']; ?>
    ...
    <!-- Address Modal - Add this before closing </body> tag in profile.php -->
    <div id="addressModal" class="modal">
        <div class="modal-content">
            <button class="modal-close" onclick="closeAddressModal()">&times;</button>
            <h2 id="addressModalTitle">Add New Address</h2>
            <p class="modal-subtitle">Fill in the details for your shipping address</p>

            <form id="addressForm" method="POST" action="add_address.php">
                <input type="hidden" id="address_id" name="address_id">
                <input type="hidden" id="form_action" name="form_action" value="add">

                <div class="form-group">
                    <label for="address_label">Address Label *</label>
                    <input type="text" id="address_label" name="address_label" placeholder="e.g., Home, Office, etc."
                        required>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="modal_phone" name="phone" placeholder="09XX XXX XXXX" maxlength="11" required>
                </div>

                <div class="form-group">
                    <label for="address_line1">Address Line 1 *</label>
                    <input type="text" id="address_line1" name="address_line1" placeholder="House/Unit No., Street Name"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="modal_postal_code" name="postal_code" placeholder="XXXX" maxlength="4"
                        required>
                </div>
...
<script>
    ...
    async function editAddress(addressId) {
        try {
            // Fetch address data
            const response = await fetch(`edit_address.php?id=${addressId}`);
            ...
            document.getElementById('address_label').value = address.address_label || '';
